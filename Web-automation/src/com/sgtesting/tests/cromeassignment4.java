...
public class cromeassignment4 {
	...
	private static void createcustomer()
	{
		try
		{
			...
			Thread.sleep(2000);
			oBrowser.findElement(By.id("customerLightBox_nameField")).sendKeys("surname");
	...
	private static void modifycustomer()
	{
		try
		{
			...
			oBrowser.findElement(By.id("//*[@id='customerLightBox_descriptionField']")).sendKeys("users");
		}catch(Exception e)
		{
			e.printStackTrace();
		}
